...
export const RiverLadder: React.FC<RiverLadderProps> = ({
  ...
  return (
    <div ref={containerRef} className="space-y-12 relative">
      ...
      <aside className="fixed right-3 sm:right-6 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2 p-2 sm:p-3 bg-[#0A0A0A]/90 border border-[#262626] rounded-2xl backdrop-blur-md shadow-2xl max-h-[85vh] overflow-y-auto">
            ...
            <button
              ...
              className={`px-2.5 py-1.5 rounded-xl text-xs font-mono-stats font-bold transition-all flex items-center gap-2 cursor-pointer border text-left ${
                isUnlocked
                  ...
                  : 'bg-[#121212]/90 border-[#222] text-[#8A8A85] hover:border-[#444] hover:text-white'
              }`}
            >
              <span className="w-5 h-5 rounded-full bg-[#0A0A0A]/20 flex items-center justify-center text-[10px] font-black flex-shrink-0">
                L{idx + 1}
              </span>
                ...
                >
                  ...
                  <div className="flex-1 w-full relative z-20">
                    <SpotlightCard
                      ...
                      className={`p-6 sm:p-10 rounded-3xl border transition-all duration-300 backdrop-blur-md ${
                        isUnlocked
                          ? 'bg-[#121212]/90 border-[#C4F62E]/50 shadow-[0_12px_48px_rgba(196,246,46,0.2)]'
                          : 'bg-[#0E0E0E]/80 border-[#202020] opacity-85'
                      }`}
                    >
                      <div className="space-y-5">
                        ...
                        <div className="flex items-center justify-between border-b border-[#242424] pb-4">
                          ...
                          {isUnlocked ? (
                            ...
                            <div className="w-10 h-10 rounded-full bg-[#181818] border border-[#262626] flex items-center justify-center text-[#6A6A65]">
                        ...
                        {/* Unlocked Privileges */}
                        <div className="bg-[#070707]/90 border border-[#1E1E1E] rounded-2xl p-5 space-y-3">
