            ...
            {LADDER_RUNGS.map((rung, idx) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-mono-stats font-bold transition-all whitespace-nowrap cursor-pointer border ${isUnlocked
          ...
          {LADDER_RUNGS.map((rung, idx) => {
            ...
            return (
              <div
                ...
                className={`relative flex flex-col md:flex-row items-center gap-6 sm:gap-10 transition-all duration-500 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'
                  }`}
              >
                {/* Starburst Effect */}
                {burstRungId === rung.id && (
                ...
                <div className="flex-1 max-w-xl w-full">
                  <SpotlightCard
                    ...
                    className={`rounded-3xl p-6 sm:p-8 space-y-5 transition-all duration-500 relative shadow-2xl border ${isUnlocked
